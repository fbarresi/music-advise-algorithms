...
\abstract{This article is an exercise about the bibliography research and its usage with La\TeX and Mendeley.
This text aims to shows five different algorithms and approaches for music recommendation systems.}

\section{Discussion}
On-demand music streaming services are nowadays part of our every day usage technologies.
The music streaming service of the fucture should of course not only play user's favorite palylist, 
but also advise users about their next favourite palylists. 
Erlier approches for building music recommendation systems make 
...
like position, wether or background sounds. 
